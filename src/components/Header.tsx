...
const Header = () => {
  ...
  return (
    <header className="w-full bg-gradient-to-br from-[#ECE08A] via-[#ECE08A] to-[#F5F1A0] shadow-sm z-50 font-inter py-[49px]">
        ...
        <div className="flex items-center space-x-3 lg:absolute lg:right-6">
          {user ? (
            ...
            <Button 
              asChild
              variant="outline"
              className="border-[#62624C] text-[#62624C] hover:bg-[#62624C] hover:text-white mr-3"
            >
              <Link to="/auth">
